...
#Question 4:Write a query to find the director who directed a movie that casted a role for 'eyes wide shut'.
Return director first_name, last_name, and movie title.
...
#Question 5:Write a query to find who directed movie that casted a role as' sean magquire'.
Return director first_name,last_name and movie_title.
...
#Question 6:Write a sql query to find the actors who have not acted in any movie between 1990 and 2000.
Return actor first_name,last_name,movie _title,release year.
...
#Question 7:Write a sql query to find the directors with the number of genres of movies.Group the result set on directors first_name,last_name and genric title.
Sort the result set in ascending order by directors first_name, last_name.Return directors first_name,last_name and numbers of genres of movies.
...
#Question 3: Find all actors with name starting with Steven.
